function startQuest() {
    ...
    if(game.choice2 === "wait") {
        game.choice3 = prompt("You find a raft and get to the castle unharmed. Inside the castle there are 3 doors; gold, purple and a green door. Which color do you choose? Type gold, purple or green.");
